window.onload = function () {
    if (window.location.href.includes('/cb_js') || window.location.href.includes('/cb_i') || window.location.href.includes('/share_cb')) {
        return;
    }
    ...
    function init() {
		...
		`
            ...
            (t.innerHTML = `
            <div>
            <div id="min_mofaai" style="position: absolute;right: 30px;top: 0;text-align:right;color:#888;cursor:pointer;">${min}</div>
            <div id="max_mofaai" style="position: absolute;right: 30px;top: 0;text-align:right;color:#888;cursor:pointer;">${max}</div>
