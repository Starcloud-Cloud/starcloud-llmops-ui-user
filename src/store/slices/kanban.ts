...
export function addColumn(column: KanbanColumn, columns: KanbanColumn[], columnsOrder: string[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/add-column', data: { column, columns, columnsOrder } });
...
export function editColumn(column: KanbanColumn, columns: KanbanColumn[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/edit-column', data: { column, columns } });
...
export function updateColumnOrder(columnsOrder: string[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/update-column-order', data: { columnsOrder } });
...
export function deleteColumn(columnId: string, columnsOrder: string[], columns: KanbanColumn[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/delete-column', data: { columnId, columnsOrder, columns } });
    ...
    return async () => {
        try {
            const response = await axios.post({
                url: '/api/kanban/add-item',
                data: { columnId, columns, item, items, storyId, userStory }
            });
...
export function editItem(
    ...
    return async () => {
        try {
            const response = await axios.post({
                url: '/api/kanban/edit-item',
                data: { items, item, userStory, storyId, columns, columnId }
            });
...
export function updateColumnItemOrder(columns: KanbanColumn[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/update-item-order', data: { columns } });
...
export function selectItem(selectedItem: string | false) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/select-item', data: { selectedItem } });
...
export function addItemComment(itemId: string | false, comment: KanbanComment, items: KanbanItem[], comments: KanbanComment[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/add-item-comment', data: { items, itemId, comment, comments } });
...
export function deleteItem(itemId: string | false, items: KanbanItem[], columns: KanbanColumn[], userStory: KanbanUserStory[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/delete-item', data: { columns, itemId, userStory, items } });
...
export function addStory(story: any, userStory: KanbanUserStory[], userStoryOrder: string[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/add-story', data: { userStory, story, userStoryOrder } });
...
export function editStory(story: KanbanUserStory, userStory: KanbanUserStory[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/edit-story', data: { userStory, story } });
...
export function updateStoryOrder(userStoryOrder: string[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/update-story-order', data: { userStoryOrder } });
...
export function updateStoryItemOrder(userStory: KanbanUserStory[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/update-storyitem-order', data: { userStory } });
...
export function addStoryComment(storyId: string, comment: KanbanComment, comments: KanbanComment[], userStory: KanbanUserStory[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/add-story-comment', data: { userStory, storyId, comment, comments } });
...
export function deleteStory(storyId: string, userStory: KanbanUserStory[], userStoryOrder: string[]) {
    return async () => {
        try {
            const response = await axios.post({ url: '/api/kanban/delete-story', data: { userStory, storyId, userStoryOrder } });
