                    ...
                    <Grid item xs={12}>
                        <MainCard elevation={4} border={false} boxShadow shadow={4} sx={{ mb: 3 }}>
                            <Stack spacing={2} sx={{ textAlign: 'left' }}>
                                ...
                                >
                                    欢迎使用由星河云海（杭州）网络技术有限公司及其关联方（以下简称“星河云海”或“我们”）合法拥有并运营的魔法矩阵产品及服务。
                                </Typography>
                                <Typography
                                    sx={{
                                        textIndent: '2em',
                                ...
                                >
                                    魔法矩阵是一个基于人工智能的营销内容创作平台。魔法矩阵相关网站、服务、产品、应用程序与内容，在《魔法矩阵用户服务协议》（以下简称“本协议”）中统称为“本服务”。个人用户、授权用户统称为“您”。
                                </Typography>
                                <Typography
                                    sx={{
                                        textIndent: '2em',
