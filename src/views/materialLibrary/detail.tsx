...
import { Button, Space, Input, Tag, Dropdown, Avatar, Popconfirm, Upload, Image, Tooltip, message, Form, Modal, Empty, Card } from 'antd';
import {
            ...
            <div className="bg-[#fff] rounded-md p-3 h-[calc(100%-80px)]">
                ...
                <div className="bg-white rounded-md border flex justify-between mb-3">
                    ...
                    <div className="flex border border-solid rounded border-[#d9d9d9]">
                        <Space>
                            <div className="flex items-center flex-col cursor-pointer py-2 w-[80px] hover:bg-[#d9d9d9]">
                                <svg
