...
const headCells = [
    ...
    { id: 'creator', numeric: false, disablePadding: false, label: ' 文案示例' },
    { id: 'creator', numeric: false, disablePadding: false, label: ' 图片示例' },
...
const Copywriting: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {detailOpen && <AddModal detailOpen={detailOpen} setDetailOpen={setDetailOpen} />}
        </MainCard>
    );
};
