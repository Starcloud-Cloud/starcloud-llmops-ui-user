                                    ...
                                    {!value && (
                                        <div className="flex w-full flex-col mb-3 mt-3">
                                            ...
                                            {currentSelect.monthCode.includes('basic') && discount?.name && (
                                                <div className="mt-2">
                                                    <div className="flex items-center justify-center px-4 max-w-[210px] rounded-lg bg-[#ff5500] cursor-pointer">
                                                        ...
                                                        <div className="flex flex-col py-1" onClick={() => handleOnSearch(discount?.code)}>
