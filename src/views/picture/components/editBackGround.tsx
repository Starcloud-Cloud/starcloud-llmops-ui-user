...
import transparent from 'assets/images/picture/下载.png';
import { useState } from 'react';
import { getAccessToken } from 'utils/auth';
const EditBackgroundImage = ({ url }: { url: string }) => {
    ...
    const props: UploadProps = {
        ...
        action: `${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_API_URL}/llm/${url}`,
        headers: {
