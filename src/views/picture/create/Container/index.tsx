                ...
                {!visible ? (
                    <>
                        <div className="flex flex-col">
                            <div className="flex justify-between">
                                ...
                                <Space>
                                    <div className="bg-neutral-500 w-7 h-7 flex justify-center items-center rounded-md cursor-pointer">
                            ...
                            <div className="flex overflow-y-auto">
                                <div className="w-200 mr-4 relative">
                                    <img
                                    ...
                                    <Space className="absolute top-2 right-2">
                                        <div className="bg-neutral-400 w-7 h-7 flex justify-center items-center rounded-md cursor-pointer">
                                            <CloudDownloadOutlined rev={undefined} style={{ color: '#fff' }} />
                                        </div>
                                        <div className="bg-neutral-400 w-7 h-7 flex justify-center items-center rounded-md cursor-pointer">
                                            <ShareAltOutlined rev={undefined} style={{ color: '#fff' }} />
                    ...
                    <div className="h-full flex justify-center items-center relative">
                        <div className="absolute right-0 top-10 flex flex-col">
                            <div
                                className="bg-neutral-500 w-7 h-7 flex justify-center items-center rounded-md cursor-pointer"
                                onClick={() => setVisible(false)}
                            >
                                <CloseCircleOutlined rev={undefined} style={{ color: '#fff' }} />
                            </div>
                            <div className="bg-neutral-500 w-7 h-7 flex justify-center items-center rounded-md cursor-pointer mt-2">
                                <CloudDownloadOutlined rev={undefined} style={{ color: '#fff' }} />
                            </div>
                            <div className="bg-neutral-500 w-7 h-7 flex justify-center items-center rounded-md cursor-pointer mt-2">
                                <ShareAltOutlined rev={undefined} style={{ color: '#fff' }} />
                        ...
                        <div className="flex justify-center items-center">
                            <button className="bg-neutral-500 flex-none w-7 h-7 flex justify-center items-center rounded-md cursor-pointer border-none">
                            ...
                            <div className="flex flex-col justify-center text-center">
                                ...
                                <div className="w-full mt-2">
                                    <img
                                        className="rounded-md w-1/12 mr-2 cursor-pointer"
                                        src="https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp"
                                        alt=""
                                    />
                                    <img
