...
import './index.scss';
import share from 'assets/images/styles/share.svg';
    ...
    return (
        ...
        RVh0ZGF0ZTptb2RpZnkAMjAyMy0wNi0wN1QxNTo0MTowNiswODowMF3D12QAAAAASUVORK5CYII="
                    ...
                    <div className="w-full h-full flex justify-center items-center flex-col">
                        <div className="text-[26px] font-[700] text-[#000]">图片裂变</div>
                        <p className="text-[20px] text-[#0009] my-[20px]">无需从零开始，上传参考图，3秒裂变出多张相似图</p>
                        <div className="flex justify-center items-center relative">
                            <Image
                                className="rounded-xl"
                                width={160}
                                src="https://ai.linkfox.com/assets/origin-1b13fd9c.png"
                                preview={false}
                            />
                            <span className="absolute left-[150px] zIndex-10">
                                <img width={40} src={share} alt="" />
                            </span>
                            <div className="ml-[20px] flex flex-wrap p-[10px] gap-2 w-[312px] bg-[#fff] border border-solid border-[#E8E8E8] rounded-xl">
                                <Image
                                    className="rounded-md"
                                    width={140}
                                    src="https://ai.linkfox.com/assets/similar1-7eb93d03.jpg"
                                    preview={false}
                                />
                                <Image
                                    className="rounded-md"
                                    width={140}
                                    src="https://ai.linkfox.com/assets/similar2-64e14a12.jpg"
                                    preview={false}
                                />
                                <Image
                                    className="rounded-md"
                                ...
                                <Image
                                    className="rounded-md"
                                    width={140}
                                    src="https://ai.linkfox.com/assets/similar4-0bf8af60.jpg"
                                    preview={false}
                                />
                            </div>
                        </div>
                        <span className="text-[20px] text-[#673ab7] mt-[20px]">可用于服装印花素材裂变，场景图裂变，创意图裂变等</span>
                    </div>
                )}
                {record && (
                    <PicModal
