import { Tabs, Carousel, Image, Button } from 'antd';
                    ...
                    items={[
                        {
                            ...
                            key: '1',
                            children: (
                                <div className="h-[calc(100vh-46px)] relative shadow-lg">
                                    <div className="h-full overflow-y-scroll">
                                        ...
                                        <div className="px-[15px]">
                                            <div className="text-lg font-[600] mt-[15px] mb-2 leading-[140%]">💥杭州宝藏洗衣上门推荐</div>
                                            <div className="text-base font-[400] leading-[150%] text-[#000]">
                                                你们有没有觉得洗衣服是一件特别麻烦的事？😩每次把一堆脏衣服放进洗衣机，洗完还得晾晒、整理，真的费时费力。😫
                                                但是！！！😎我发现了一个宝藏洗衣（程序猿干洗到家）上门取送的洗衣服务👕。
                                                📝只需要在美团或者大众点评下单，就会有专人上门来收取要洗的衣物🛒，洗完之后再给你送回来，简直不要太贴心🥰。
                                                而且他们的洗衣质量也超棒👍，不管是污渍还是顽固的印记，都能处理得干干净净🧼。价格也非常实惠，性价比超高💯。
                                                🤗有了这个服务，咱们可以节省出更多时间来做自己喜欢的事情啦，真的是懒人必备😜。
                                                都给我冲！！！😜
                                                你们有没有觉得洗衣服是一件特别麻烦的事？😩每次把一堆脏衣服放进洗衣机，洗完还得晾晒、整理，真的费时费力。😫
                                                但是！！！😎我发现了一个宝藏洗衣（程序猿干洗到家）上门取送的洗衣服务👕。
                                                📝只需要在美团或者大众点评下单，就会有专人上门来收取要洗的衣物🛒，洗完之后再给你送回来，简直不要太贴心🥰。
